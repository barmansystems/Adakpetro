...
<html lang="fa" dir="rtl" data-topbar-color="brand">
    <head>
        <meta charset="utf-8" />
        <title>آداک پترو خورشید قشم | ورود</title>
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="javascript:void(0)" class="logo logo-dark text-center">
                                            <span class="logo-lg mb-2">
                                                <img src="/assets/images/img/adak-petro-logo-red.png" alt="" height="70">
                                            </span>
                                        </a>

                                        <a href="javascript:void(0)" class="logo logo-light text-center">
                                            <span class="logo-lg">
                                                <img src="/assets/images/img/adak-petro-white-logo.png" alt="" height="70">
                                            </span>
                                        </a>
                                    </div>
                                </div>
