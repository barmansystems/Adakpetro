...
{{--                                    </div>--}}
                                    ...
                                    <div class="mb-2 col-xl-3 col-lg-3 col-md-3">
                                        ...
                                        <select name="header" class="form-control" id="header">
                                            <option value="info">سربرگ فارسی آداک پترو (Info)</option>
                                            <option value="sale">سربرگ فارسی آداک پترو (Sale)</option>
                                            <option value="english">سربرگ انگلیسی آداک پترو</option>
                                        </select>
                                        @error('header')
                                        <div class="invalid-feedback text-danger d-block">{{ $message }}</div>
                                        @enderror
