...
<div class="left-side-menu">
    ...
    <div class="logo-box">
        <a href="javascript:void(0)" class="logo logo-dark text-center">
            <span class="logo-sm">
                <img src="/assets/images/img/logo-adak-petro-sm-red.png" alt="" height="24">
                <!-- <span class="logo-lg-text-light">Minton</span> -->
            </span>
            <span class="logo-lg">
                <img src="/assets/images/img/adak-petro-logo-red.png" alt="" height="20">
                <!-- <span class="logo-lg-text-light">M</span> -->
            </span>
        </a>
        <a href="javascript:void(0)" class="logo logo-light text-center">
            <span class="logo-sm">
                <img src="/assets/images/img/logo-adak-petro-sm-white.png" alt="" height="54">
            </span>
            <span class="logo-lg">
                <img src="/assets/images/img/adak-petro-white-logo.png" alt="" height="60">
            </span>
        </a>
    </div>
